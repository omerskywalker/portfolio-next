...
const Navbar = () => {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-10 bg-[#121212] bg-opacity-100">
            ...
            <Link href="/"><Image className=" text-white bg-white" src="/images/os-icon.png" alt="os logo" width={40} height={40} /></Link>
                <div className="mobile-menu block md:hidden pr-1">
